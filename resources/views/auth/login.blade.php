        ...
        <div class="container">
            <div class="row g-4 align-items-stretch">
                <div class="col-lg-6 d-flex">
                    <section class="auth-info-panel w-100" aria-labelledby="login-title">
                        <p class="eyebrow mb-2">Welcome Back</p>
                        <h1 id="login-title" class="display-6 fw-bold mb-3">Sign in to AccessForm</h1>
                        <p class="mb-4">
                            Continue to your accessibility-first dashboard and manage inclusive surveys with confidence.
                        </p>

                        <ul class="list-unstyled auth-point-list mb-0">
                            <li>Keyboard-friendly workflows and visible focus states</li>
                            <li>Role-based access for Admin, FormCreator, and Respondent</li>
                            <li>Secure auth flows powered by Laravel Breeze</li>
                        </ul>
                    </section>
                </div>

                <div class="col-lg-6 d-flex">
                    <section class="auth-form-panel w-100" aria-labelledby="signin-card-title">
                        <h2 id="signin-card-title" class="h3 mb-3">Login</h2>
                        ...
                        <form method="POST" action="{{ route('login') }}" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <div id="role-help" class="form-text">Select the role linked to this account.</div>
                                @error('role')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="d-flex justify-content-between flex-wrap gap-2">
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="auth-inline-link">Forgot your password?</a>
                                @endif
                                <a href="{{ route('register') }}" class="auth-inline-link">Need an account? Register</a>
                            </div>
                        </form>
                    </section>
                </div>
